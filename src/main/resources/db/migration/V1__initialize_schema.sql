...
-- refresh_tokens table: Skip creation if table exists
-- Existing production tables may have different column names/structure
-- All refresh_tokens table modifications are handled in V2 migration
